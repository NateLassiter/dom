...
(function($) {
    ...
    var createOverlayLoader = function () {
        ...
        qLoverlay = $("<div id='"+qLoptions.overlayId+"'></div>")
            .html('<div class="loader-content"><img src="../static/img/logo-stacked.png"><small>A Music Magazine</small><img src="../static/img/issues-icon.png" class="loading-img"><p>loading...</p></div>')
            .css({
                width: "100%",
                height: "100%",
